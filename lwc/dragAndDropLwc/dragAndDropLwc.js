    ...
    @wire(getListUi, {
        ...
        if(data){
            ...
            this.records = data.records.records.map(item => {
                ...
                return { 
                        'Id': field.Id.value, 'Name': field.Name.value,
                        'AccountId': account.Id.value, 'AccountName': account.Name.value,
                        'CloseDate': field.CloseDate.value, 'StageName': field.StageName.value,
                        'Amount': field.Amount.value, 
                        'LeadSource': 'None',
                        'OwnerId': field.Owner.displayValue || 'None',
                        'Probability': 'None',
                        'Type': 'None'
                    }
...
/*** fetching Stage Picklist ***/
    ...
    @wire(getPicklistValues, {
        ...
        if(data){
            console.log("Stage Picklist0", data)
    ...
    get calcWidth() {
        ...
        console.log("Length:", len); // Print len in the console
